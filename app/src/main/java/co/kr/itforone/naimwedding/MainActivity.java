package co.kr.itforone.naimwedding;
...
import co.kr.itforone.naimwedding.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void webViewSetting() {
        ...
        setting.setUserAgentString("Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Mobile Safari/537.36"+"/ANAIMWEDDING");
        ...
        chrome = new WebChromeClient() {
            ...
            public boolean onShowFileChooser(
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {// API 24 이상 일경우..
                    File imageStorageDir = new File(MainActivity.this.getFilesDir() + "/naimwedding", "naimwedding");
                    ...
                    File imageStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "naimwedding");
                    if (!imageStorageDir.exists()) {
                        // Create AndroidExampleFolder at sdcard
                        imageStorageDir.mkdirs();
                    }
...
//                    filePathCallbackLollipop.onReceiveValue(null);
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("image/*");
                //i.putExtra(Intent.EXTRA_ALLOW_MULTIPLE, true); // 갤러리에서 여러 이미지를 선택하고자 할 경우
